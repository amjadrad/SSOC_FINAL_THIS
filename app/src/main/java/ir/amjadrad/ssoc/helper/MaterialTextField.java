...
public class MaterialTextField extends FrameLayout {
    ...
    public void expand() {
        if (!expanded) {
            ...
            ViewCompat.animate(label)
                    ...
                    .scaleX(0.99f)
                    .scaleY(1f)
                    .translationY(-(labelTopMargin+15))
                    .setDuration(ANIMATION_DURATION);
    ...
    protected void onFinishInflate() {
        ...
        addView(LayoutInflater.from(getContext()).inflate(R.layout.frame_edit_text_material, this, false));
        ...
        label.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "font/sahel.ttf"));
